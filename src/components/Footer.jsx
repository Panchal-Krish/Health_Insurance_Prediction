                ...
                <div className="footer-content">
                    ...
                    <div className="footer-section footer-brand">
                        ...
                        <p className="footer-mission">
                            Empowering individuals with AI-driven insurance predictions.
                        </p>
                    </div>
                    ...
                    <div className="footer-section">
                        ...
                        <ul className="footer-contact">
                            ...
                            <li>
                                ...
                                <a href="tel:+919173387806" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                    +91 9999000000
                                </a>
                            </li>
                            <li>
                    ...
                    <div className="footer-section">
                        ...
                        <p className="footer-social-text">
                            Stay updated with our latest prediction insights and features.
                        </p>
